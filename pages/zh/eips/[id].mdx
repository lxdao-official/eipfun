...
<>
  ...
  <Container maxWidth="lg">
    ...
    <Typography pb={4} display="flex" variant="subtitle2" height={46} sx={{background: "url('/images/eip_details_author.png') no-repeat left center"}} pl={5.125} alignItems="center" variant="subtitle2" component={Box}>
