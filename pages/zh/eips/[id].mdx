...
<>
  ...
  <Container maxWidth="lg">
    ...
    <Typography className={detials.floatWrap} variant="subtitle2" sx={{background: "url('/images/eip_details_author.png') no-repeat left center"}} pl={5.125} py={0.75} variant="subtitle2" component={Box}>
