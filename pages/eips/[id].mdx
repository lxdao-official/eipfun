...
export async function getServerSideProps(context) {
  ...
  let originalEIP = fs.readFileSync(`./original-eips/eips/${id}.md`, 'utf8');
  let [, meta, ...con] = originalEIP.split('---');
  meta = formatMeta(meta);
  if (fs.existsSync(`./eips/en/${id}.md`)) {
    let comEIP = fs.readFileSync(`./eips/en/${id}.md`, 'utf8');
