  ...
  <Container maxWidth="lg" sx={{position: "relative"}} >
    ...
    <Box display='flex'>
      <Box width={840} mr={3}>
        ...
        <Box position="fixed" left={0} top={200} width={300} display="none">
          <Toc markdownText={jsxData} lowestHeadingLevel={2} type="row" className={detials.eipEnmu} titleLimit={30} customMatchers={{"`": ""}} />
        </Box>
