...
<>
  ...
  <Container maxWidth="lg" sx={{position: "relative"}} >
    ...
    <Typography mb={4} display="flex" height={46} sx={{background: "url('/images/eip_details_author.png') no-repeat left center"}} pl={5.125} alignItems="center" variant="subtitle2" component={Box} >
