...
<>
  ...
  <Container maxWidth="lg">
    ...
    <Box pb={4} pt={2}>
      <Typography display='inline-block' component="span" variant="body2" color="#FFC700" fontSize={14} borderRadius="5px" px={1} mr={2} style={{ background: '#FFFAE9'}}>{meta.status}</Typography>
      ...
      <Box sx={{flex: 1}}>
        <Box pt={3} px={3} border={1} borderColor="#eaebf0" borderRadius={'10px'}>
          {meta.projects?.length > 0 && <Typography fontWeight="bold" variant="h6" pb={3}>Adopted by projects</Typography>}
            ...
            <Box id="details-toc" pt={4} pb={3} borderTop={1} borderColor={meta.projects?.length > 0 ? "#ECECEC" : 'transparent'} sx={{background: '#fff', transition: 'all 200ms'}} zIndex={2}>
